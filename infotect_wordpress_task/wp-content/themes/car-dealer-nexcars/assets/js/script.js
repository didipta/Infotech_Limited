...
jQuery(window).on('load', function( $ ){
    ...
    */
    ...
    var car_dealer_nexcars_menu_is_focus = false;
/*
    jQuery(".mobile-menu li.has-sub-menu > a").on("click", function(e) {
        if(!car_dealer_nexcars_menu_is_focus){
    ...
    jQuery(".mobile-menu li.has-sub-menu > a").on("focus", function(e) {
        jQuery(this).next("ul").slideToggle();
        car_dealer_nexcars_menu_is_focus = true;
        setTimeout(()=>{ car_dealer_nexcars_menu_is_focus = false;}, 500);
        return false;
    });
