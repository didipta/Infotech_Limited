 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme car_dealer_nexcars
...
add_action( 'tgmpa_register', 'car_dealer_nexcars_register_required_plugins' );
 ...
 */
function car_dealer_nexcars_register_required_plugins() {
	/*
	...
	$config = array(
		'id'           => 'car-dealer-nexcars',                 // Unique ID for hashing notices for multiple instances of TGMPA.
